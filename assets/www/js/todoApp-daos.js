...
(function($){
	if(todoApp.isChrome || todoApp.isSafari){
		...
		brite.registerDao("todo",new brite.dao.SQLiteDao("Todos","id",[{column:'taskName',dtype:'TEXT'},{column:'startDate',dtype:'TEXT'},{column:'endDate',dtype:'TEXT'},{column:'status',dtype:'INTEGER'},{column:'imageId',dtype:'INTEGER'}]));
