(function($){
    ...
    ImagePicker.prototype.init = function (data, config) {
        var c = this;
        var $e = c.$element;
    ...
    ImagePicker.prototype.postDisplay = function (data, config) {
        var c = this;
        var $e = c.$element;
		       		...
		       		if (c.isValid) {
		       			...
		       			c.$imgHidden.bind("load",function(){
		       				if (c.width + "px" == c.$imgHidden.css("width") && c.height + "px" == c.$imgHidden.css("height")) {
		       					...
		       					c.$imgHidden.closest(".ImagePicker").find(".validation-message").remove();
								...
								c.$imgHidden.closest(".ImagePicker").find("form")[0].reset();
		       				}
		       			})
		       		}else{
						showPickedImage.call(c,url);
	...
	ImagePicker.prototype.validate = function() {
		var c = this;
		var $e = c.$element;
	...
	ImagePicker.prototype.getCurrentImageSrc = function(){
		var c = this;
	...
	ImagePicker.prototype.imageSrcChange = function(listener) {
	...
	brite.registerComponent("ImagePicker", {
		emptyParent : true,
		loadTemplate:true
	}, function() {
